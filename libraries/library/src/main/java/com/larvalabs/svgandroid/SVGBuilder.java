...
public class SVGBuilder {
    ...
    public SVGBuilder setLimits(int width, int height) {
        limits = new RectF(0,0,width,height);
        return this;
    }
	...
	public SVG build() throws SVGParseException {
		...
		try {
            ...
            if(limits!=null) {
                handler.limits.left = 0;
                handler.limits.right = limits.right;
                handler.limits.top = 0;
                handler.limits.bottom = limits.bottom;
            }
