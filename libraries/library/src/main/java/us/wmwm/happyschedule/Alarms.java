...
public class Alarms {
	...
	public static void saveAlarm(Context ctx, Alarm alarm) {
		Log.d(TAG,"save alarm " + alarm.getId());
	...
	public static void removeAlarm(Context ctx, Alarm alarm) {
		Log.d(TAG, "remove alarm " + alarm.getId());
	...
	public static void startAlarm(Context ctx, Alarm alarm) {		
		...
		PendingIntent pi = PendingIntent
                .getActivity(ctx, 0, AlarmActivity.from(ctx, alarm.getStationToStation(), alarm.getTime(), alarm.getType(), alarm.getId()) , 0);
        ...
        Log.d(TAG, "Alarm going off at " + alarm.getTime().getTime());
