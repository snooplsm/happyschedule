...
import us.wmwm.happyschedule.model.ConnectionInterval;
...
public class ScheduleDao {
	...
	public Schedule getSchedule(final String departStationId,
        ...
        Log.d(TAG, "Getting schedule for " + departStationId + " to " + arriveStationId + " between " + start + " to " + end);
...
//		System.out.println("end   : " + endString);
	...
	public String getBlockId(String blockId) {
		// TODO Auto-generated method stub
		Cursor c = Db.get().db.rawQuery("select trip_id from nested_trip where block_id=?",new String[]{blockId});
		try {
			if(c.moveToNext()) {
