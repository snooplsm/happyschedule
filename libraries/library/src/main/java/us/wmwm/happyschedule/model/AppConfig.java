...
public class AppConfig {
	...
	private AppConfig(JSONObject o) {
...
//    public Map<String,LineStyle> getLine(String id) {
//        Map<String,LineStyle> lines = new HashMap<String, LineStyle>();
//        if(this.lines!=null) {
//            for(LineStyle line: lines) {
//                lines.put(line.)
//            }
//        }
//    }
    ...
    public static AppConfig get() {
        if(INSTANCE==null) {
            try {
                INSTANCE = new AppConfig(new JSONObject(Streams.readFully(Streams.getStream("config.json"))));
