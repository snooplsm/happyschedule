...
public class StickyListHeadersListView extends FrameLayout {
    ...
    /* --- Delegates --- */
    private Set<OnScrollListener> mOnScrollListenerDelegate = new HashSet<OnScrollListener>();
    ...
    private class WrapperListScrollListener implements OnScrollListener {
        ...
        public void onScroll(AbsListView view, int firstVisibleItem,
            ...
            if (mOnScrollListenerDelegate != null) {
                for(OnScrollListener listener : mOnScrollListenerDelegate) {
        ...
        public void onScrollStateChanged(AbsListView view, int scrollState) {
            if (mOnScrollListenerDelegate != null) {
                for(OnScrollListener listener : mOnScrollListenerDelegate) {
                    listener.onScrollStateChanged(view,
                            scrollState);
                }
            }
        }
    ...
    public void setOnScrollListener(OnScrollListener onScrollListener) {
        if(onScrollListener!=null) {
            mOnScrollListenerDelegate.add(onScrollListener);
        }
    }
